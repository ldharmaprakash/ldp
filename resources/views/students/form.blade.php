<div class="card">
    ...
    <div class="card-body">
        <div class="form-group mb-3">
            ...
            <input type="text" name="name" value="{{ old('name', $result->name) }}" class="form-control"
                id="name" placeholder="Name">
            <span class="text-danger">{{ $errors->first('name') }}</span>
        </div>
        <div class="form-group mb-3">
            <label for="description"> Description <em class="text-danger">* </em> </label>
            <input type="text" name="description" value="{{ old('description', $result->description) }}"
                        ...
                        <div class="col-3">
                            <div class="form-check">
                                <input type="checkbox" name="permission[]" class="form-check-input"
                                    ...
                                    :checked="{{ in_array($permission->id, $old_permissions) ? 'true' : 'false' }}">
