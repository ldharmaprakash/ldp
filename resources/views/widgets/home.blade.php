                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg end">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img" src="{{ asset('images/user3-128x128.jpg') }}" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('images/user7-128x128.jpg') }}" alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('images/user3-128x128.jpg') }}" alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('images/user5-128x128.jpg') }}" alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('images/user6-128x128.jpg') }}" alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ asset('images/user8-128x128.jpg') }}" alt="User Avatar">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="row text-center m-1">
                                    <div class="col-3 p-2">
                                        <img class="img-fluid rounded-circle" src="{{ asset('images/user1-128x128.jpg') }}" alt="User Image">
                                    ...
                                    <div class="col-3 p-2">
                                        <img class="img-fluid rounded-circle" src="{{ asset('images/user7-128x128.jpg') }}" alt="User Image">
                                        <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                            Jane
                                        </a>
                                    ...
                                    <div class="col-3 p-2">
                                        <img class="img-fluid rounded-circle" src="{{ asset('images/user6-128x128.jpg') }}" alt="User Image">
                                        <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                            John
                                        </a>
                                        <div class="fs-8">12 Jan</div>
                                    ...
                                    <div class="col-3 p-2">
                                        <img class="img-fluid rounded-circle" src="{{ asset('images/user2-160x160.jpg') }}" alt="User Image">
                                        <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                            Alexander
                                        </a>
                                    ...
                                    <div class="col-3 p-2">
                                        <img class="img-fluid rounded-circle" src="{{ asset('images/user5-128x128.jpg') }}" alt="User Image">
                                        <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                            Sarah
                                        </a>
                                    ...
                                    <div class="col-3 p-2">
                                        <img class="img-fluid rounded-circle" src="{{ asset('images/user4-128x128.jpg') }}" alt="User Image">
                                        <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                            Nora
                                        </a>
                                    ...
                                    <div class="col-3 p-2">
                                        <img class="img-fluid rounded-circle" src="{{ asset('images/user3-128x128.jpg') }}" alt="User Image">
                                        <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0" href="#">
                                            Nadia
                                        </a>
                                        <div class="fs-8">15 Jan</div>
